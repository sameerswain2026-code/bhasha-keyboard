    ...
    visual: Column(
      children: [
        _FeatureCard(
          ...
          text: 'Native scripts, Roman typing and effortless switching.',
        ),
        _FeatureCard(
          t: t,
          index: '02',
          ...
          text: 'Transcribe, translate and let your words flow.',
        ),
        _FeatureCard(
          t: t,
          index: '03',
          icon: Icons.auto_awesome_rounded,
          title: 'A private toolkit',
          text: 'Smart tools, documents and expressive media in one place.',
        ),
      ],
    ),
  );
...
class _StoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListView(
    ...
    children: [
      ...
      Text(
        body,
        style: TextStyle(fontSize: 14, height: 1.5, color: t.keyTextSecondary),
      ),
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(
      children: [
        ...
        FilledButton(
          onPressed: page == 2 ? onFinish : onNext,
          child: Text(page == 2 ? 'Open Aura' : 'Continue'),
        ),
      ],
    ),
  );
...
class _AuraMark extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(
          color: const Color(0xFF6D5BFF).withValues(alpha: .28),
          blurRadius: size * .35,
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      gradient: const LinearGradient(
        ...
        colors: [Color(0xFF171A38), Color(0xFF302269), Color(0xFF133E5B)],
      ),
      borderRadius: BorderRadius.circular(28),
      boxShadow: const [
        BoxShadow(
          color: Color(0x334F35C7),
          blurRadius: 28,
          offset: Offset(0, 14),
        ),
      ],
    ...
    child: Stack(
      children: [
        Positioned(
          top: 18,
          right: 22,
          child: _GlowOrb(size: 72, color: const Color(0xFF40D9C2)),
        ),
        Positioned(
          bottom: 18,
          left: 20,
          child: _GlowOrb(size: 56, color: const Color(0xFFE66CFF)),
        ),
        Center(
          child: Container(
            width: 132,
        ...
        Positioned(
          left: 18,
          bottom: 14,
          child: _GlassPill(icon: Icons.mic_rounded, label: 'VOICE'),
        ),
        Positioned(
          right: 18,
          top: 14,
          child: _GlassPill(icon: Icons.auto_awesome_rounded, label: 'AURA'),
        ),
      ],
    ),
  );
...
class _GlowOrb extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      shape: BoxShape.circle,
      boxShadow: [
        BoxShadow(color: color.withValues(alpha: .28), blurRadius: size * .7),
      ],
    ),
  );
}
...
class _FeatureCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: t.keyBg.withValues(alpha: .82),
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                const Color(0xFF7C4DFF).withValues(alpha: .12),
              ],
            ),
...
class _AmbientBackdrop extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
    ...
    builder: (_, __) => Positioned.fill(
      child: CustomPaint(painter: _AuraPainter(animation.value, dark)),
    ),
  );
}
...
class _AuraPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset(size.width * (.18 + value * .1), size.height * .22),
      130,
      paint,
    );
    paint.color = const Color(0xFF40D9C2).withValues(alpha: dark ? .08 : .045);
    canvas.drawCircle(
      Offset(size.width * (.9 - value * .08), size.height * .72),
      150,
      paint,
    );
  }
  ...
  bool shouldRepaint(covariant _AuraPainter oldDelegate) =>
      oldDelegate.value != value || oldDelegate.dark != dark;
}
